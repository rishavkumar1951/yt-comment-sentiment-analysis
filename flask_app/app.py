...
def load_model_and_vectorizer(model_name, model_version, vectorizer_path):
    ...
    mlflow.set_tracking_uri("http://ec2-54-208-191-106.compute-1.amazonaws.com:5000/")  # Replace with your MLflow tracking URI
    client = MlflowClient()
...
def predict():
    ...
    # app.logger.error(type(comments), type(data), type(request))
